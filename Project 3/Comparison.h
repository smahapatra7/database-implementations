...
public:
	...
	// create an OrderMaker that can be used to sort records
	// based upon ALL of their attributes from a file
	OrderMaker(std::ifstream &myfile);
	// print to the screen
	void Print ();
		// print to the file
	void Printfile (std::ofstream &myfile);

	static void qoMaker(OrderMaker* sortOrder, const CNF& query,
...
public:
	...
	void Print ();
		...
		OrderMaker* CnfqoMaker(OrderMaker &srtorder);
