...
const char *tpch_dir ="/Users/shibanimahapatra/Documents/Graduate - UFL/Sem 2 Spring 2020/DBI/Project/P1 2/"; // dir where dbgen tpch files (extension *.tbl) can be found
