...
char *tpch_dir ="/Users/shibanimahapatra/Documents/Graduate - UFL/Sem 2 Spring 2020/DBI/Project/Project 2 part 1/a2test/"; // dir where dbgen tpch files (extension *.tbl) can be found
char *dbfile_dir = ""; 
